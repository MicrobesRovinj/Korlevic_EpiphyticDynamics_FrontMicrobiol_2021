...
sobs <- ggplot(plot, aes(x=station, y=mean_sobs)) +
  geom_boxplot(notch=TRUE) +
  labs(x="Depth", y="Number of OTUs") +
  theme_classic()
chao <- ggplot(plot, aes(x=station, y=mean_chao)) +
  geom_boxplot(notch=TRUE) +
  labs(x="Depth", y="Number of OTUs") +
  theme_classic()
ace <- ggplot(plot, aes(x=station, y=mean_ace)) +
  geom_boxplot(notch=TRUE) +
  labs(x="Depth", y="Number of OTUs") +
  theme_classic()
shannon <- ggplot(plot, aes(x=station, y=mean_shannon)) +
  geom_boxplot(notch=TRUE) +
  labs(x="Depth", y="Shannon Diversity Index") +
  theme_classic()
invsimpson <- ggplot(plot, aes(x=station, y=mean_invsimpson)) +
  geom_boxplot(notch=TRUE) +
