...
\autoref{supp-nseq_notus}) through rarefaction resulting in 17,119
different OTUs with 373 to 2,033 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,682.3 ±
132.1 OTUs{]} and monospecific {[}Number of OTUs, 1,741.2 ± 163.6
OTUs{]}) than for \emph{C. nodosa} (Number of OTUs, 1,050.8 ± 202.7
OTUs) and lowest values were obtained for the microbial community of the
ambient seawater (Number of OTUs, 532.9 ± 141.3 OTUs)
...
proportion of total sequences (39.1 -- 52.8 \si{\percent}). To further
...
0.55, \emph{p} \textless{} 0.01). For \emph{C. cylindracea} associated
...
accounting for a high proportion of sequences (\(\leq\) 52.8
