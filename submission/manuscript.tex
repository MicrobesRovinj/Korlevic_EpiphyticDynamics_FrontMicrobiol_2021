...
different OTUs with 352 to 2,002 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,680.8 ±
130.0 OTUs{]} and monospecific {[}Number of OTUs, 1,731.2 ± 156.7
OTUs{]}) than for \emph{C. nodosa} (Number of OTUs, 1,055.4 ± 212.2
OTUs) and lowest values were obtained for the microbial community of the
ambient seawater (Number of OTUs, 527.6 ± 142.7 OTUs)
...
proportion of total sequences (38.7 -- 52.2 \si{\percent}). To further
...
accounting for a high proportion of sequences (\(\leq\) 52.2
