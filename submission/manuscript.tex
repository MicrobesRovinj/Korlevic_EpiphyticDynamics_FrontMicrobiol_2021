...
(\autoref{supp-nseq_notus}), through rarefaction resulting in 17,055
different OTUs that ranged from 370 to 2,033 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,691.5 ±
144.4 OTUs{]} and monospecific {[}Number of OTUs, 1,733.3 ± 156.8
OTUs{]}), middle values for \emph{C. nodosa} (Number of OTUs, 1,060.9 ±
216.1 OTUs) and lower values for picoplankton communities in the ambient
seawater (Number of OTUs, 527.5 ± 147.8 OTUs)
...
These OTUs also made a high proportion of total sequences (40.3 -- 53.7
...
were accounting for a high proportion of sequences (\(\leq\) 53.7
