...
(\autoref{supp-nseq_notus}), through rarefaction resulting in 17,043
different OTUs that ranged from 352 to 1,999 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,673.1 ±
132.8 OTUs{]} and monospecific {[}Number of OTUs, 1,739.1 ± 161.9
OTUs{]}), middle values for \emph{C. nodosa} (Number of OTUs, 1,045.2 ±
209.6 OTUs) and lower values for picoplankton communities in the ambient
seawater (Number of OTUs, 526.1 ± 140.4 OTUs)
...
These OTUs also made a high proportion of total sequences (39.4 -- 52.0
...
were accounting for a high proportion of sequences (\(\leq\) 52.0
