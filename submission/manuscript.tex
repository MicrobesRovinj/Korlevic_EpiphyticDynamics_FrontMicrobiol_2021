...
of reads per sample ranged between 8,410 and 77,465 sequences
...
of sequences mentioned before reads were clustered into 28,729 different
OTUs at a similarity level of 97 \si{\percent}. Reads numbers were
normalized to the minimum number of sequences, 8,410
(\autoref{supp-nseq_notus}), through rarefaction resulting in 17,019
different OTUs that ranged from 355 to 2,018 OTUs per sample
...
found for \emph{C. cylindracea} (invaded {[}Number of OTUs, 1,690.5 ±
152.3 OTUs{]} and noninvaded {[}Number of OTUs, 1,733.8 ± 163.5
OTUs{]}), middle vales for \emph{C. nodosa} (Number of OTUs, 1,066.9 ±
224.5 OTUs) and lower values for picoplankton communities in the ambient
seawater (Number of OTUs, 526 ± 145.6 OTUs)
...
These OTUs made also a high proportion of total sequences (39.9 -- 52.8
...
Autumn/Winter samples (ANOSIM, R = 0.54, \emph{p} \textless{} 0.01),
...
were accounting for a high proportion of sequences (\(\leq\) 52.8
