...
\autoref{supp-nseq_notus}) through rarefaction resulting in 17,082
different OTUs with 379 to 2,017 OTUs per sample
...
139.6 OTUs{]} and monospecific {[}Number of OTUs, 1,735.2 ± 160.1
OTUs{]}) than for \emph{C. nodosa} (Number of OTUs, 1,052.8 ± 216.1
OTUs) and lowest values were obtained for the microbial community of the
ambient seawater (Number of OTUs, 528.8 ± 145.4 OTUs)
...
proportion of total sequences (37.8 -- 53.6 \si{\percent}). To further
