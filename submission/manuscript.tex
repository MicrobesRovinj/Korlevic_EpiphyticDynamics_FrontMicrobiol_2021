...
(\autoref{supp-nseq_notus}), through rarefaction resulting in 17,039
different OTUs that ranged from 380 to 2,023 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,687.6 ±
121.1 OTUs{]} and monospecific {[}Number of OTUs, 1,738.4 ± 160.6
OTUs{]}), middle values for \emph{C. nodosa} (Number of OTUs, 1,062 ±
218.2 OTUs) and lower values for picoplankton communities in the ambient
seawater (Number of OTUs, 524.8 ± 146.3 OTUs)
...
These OTUs also made a high proportion of total sequences (39.6 -- 52.6
