...
(\autoref{supp-nseq_notus}), through rarefaction resulting in 17,084
different OTUs that ranged from 369 to 2,027 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,692.7 ±
142.2 OTUs{]} and monospecific {[}Number of OTUs, 1,729.2 ± 163.4
OTUs{]}), middle values for \emph{C. nodosa} (Number of OTUs, 1,051.8 ±
212.2 OTUs) and lower values for picoplankton communities in the ambient
seawater (Number of OTUs, 530.7 ± 140.9 OTUs)
...
These OTUs also made a high proportion of total sequences (40.6 -- 51.4
...
were accounting for a high proportion of sequences (\(\leq\) 51.4
