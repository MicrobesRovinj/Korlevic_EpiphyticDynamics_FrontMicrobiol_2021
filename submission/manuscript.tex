...
\autoref{supp-nseq_notus}) through rarefaction resulting in 17,079
different OTUs with 384 to 2,062 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,684.1 ±
133.8 OTUs{]} and monospecific {[}Number of OTUs, 1,731.9 ± 163.8
OTUs{]}) than for \emph{C. nodosa} (Number of OTUs, 1,058.2 ± 214.5
OTUs) and lowest values were obtained for the microbial community of the
ambient seawater (Number of OTUs, 523.9 ± 138.7 OTUs)
...
proportion of total sequences (39.5 -- 52.3 \si{\percent}). To further
...
accounting for a high proportion of sequences (\(\geq\) 39.5
