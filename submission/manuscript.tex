...
\autoref{supp-nseq_notus}) through rarefaction resulting in 17,016
different OTUs with 368 to 2,042 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,691.2 ±
131.0 OTUs{]} and monospecific {[}Number of OTUs, 1,730.6 ± 169.4
OTUs{]}) than for \emph{C. nodosa} (Number of OTUs, 1,055.5 ± 209.1
OTUs) and lowest values were obtained for the microbial community of the
ambient seawater (Number of OTUs, 525.2 ± 144.9 OTUs)
...
proportion of total sequences (37.2 -- 51.2 \si{\percent}). To further
...
associated communities (ANOSIM, R = 0.32, \emph{p} \textless{} 0.01)
(\autoref{pcoa}).
...
accounting for a high proportion of sequences (\(\leq\) 51.2
