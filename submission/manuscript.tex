...
\autoref{supp-nseq_notus}) through rarefaction resulting in 17,087
different OTUs with 361 to 2,028 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,681.8 ±
124.2 OTUs{]} and monospecific {[}Number of OTUs, 1,746 ± 161.4 OTUs{]})
than for \emph{C. nodosa} (Number of OTUs, 1,052.8 ± 209.5 OTUs) and
lowest values were obtained for the microbial community of the ambient
seawater (Number of OTUs, 527.8 ± 140.4 OTUs)
...
proportion of total sequences (39.5 -- 52.4 \si{\percent}). To further
...
\interlinepenalty=10000 \emergencystretch=3.5em
