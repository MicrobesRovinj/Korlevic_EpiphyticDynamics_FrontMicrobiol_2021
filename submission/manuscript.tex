...
(\autoref{supp-nseq_notus}), through rarefaction resulting in 17,115
different OTUs that ranged from 372 to 2,084 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,684.6 ±
140.0 OTUs{]} and monospecific {[}Number of OTUs, 1,735 ± 172.0
OTUs{]}), middle values for \emph{C. nodosa} (Number of OTUs, 1,059.7 ±
208.8 OTUs) and lower values for picoplankton communities in the ambient
seawater (Number of OTUs, 531.7 ± 141.4 OTUs)
...
These OTUs also made a high proportion of total sequences (40.1 -- 51.4
