...
do not allow high taxonomic resolution were used (Tujula \emph{et al.},
2010; Lachnit \emph{et al.}, 2011; Miranda \emph{et al.}, 2013; Michelou
\emph{et al.}, 2013). In the present study we describe the seasonal
dynamics of bacterial and archaeal communities on the surfaces of the
seagrass \emph{Cymodocea nodosa} and siphonous macroalgae \emph{Caulerpa
cylindracea} determined on a mostly monthly scale. Bacterial and
archaeal epiphytes were sampled in a meadow of \emph{C. nodosa} invaded
by the invasive \emph{C. cylindracea} and in a locality of only \emph{C.
cylindracea} located in the proximity of the meadow. In addition, for
comparison, the community of the ambient seawater was characterized.
...
of reads per sample ranged between 8,409 and 77,465 sequences
...
of sequences mentioned before reads were clustered into 28,691 different
OTUs at a similarity level of 97 \si{\percent}. Read numbers were
normalized to the minimum number of sequences, 8,409
(\autoref{supp-nseq_notus}), through rarefaction resulting in 17,071
different OTUs that ranged from 386 to 2,009 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,679.5 ±
127.4 OTUs{]} and monospecific {[}Number of OTUs, 1,736.3 ± 156.5
OTUs{]}), middle values for \emph{C. nodosa} (Number of OTUs, 1,059 ±
216.2 OTUs) and lower values for picoplankton communities in the ambient
seawater (Number of OTUs, 528.2 ± 135.4 OTUs)
...
These OTUs also made a high proportion of total sequences (39.9 -- 51.8
...
supported (ANOSIM, R = 0.30, \emph{p} \textless{} 0.05)
(\autoref{pcoa}).
...
autumn and for seawater communities in winter (8.8 ± 7.4 \si{\percent}).
...
(Burke \emph{et al.}, 2011b; Michelou \emph{et al.}, 2013; Roth-Schulze
\emph{et al.}, 2016; Crump \emph{et al.}, 2018; Ugarelli \emph{et al.},
2019). These data indicate that marine macrophytes are selecting, from a
pool of seawater microbial taxa, the one that can colonize and
proliferate on their surfaces (Salaün \emph{et al.}, 2012; Michelou
\emph{et al.}, 2013). In contrast to these findings Fahimipour \emph{et
al.} (2017) found, in a global study of \emph{Zostera marina},
...
were accounting for a high proportion of sequences (\(\leq\) 51.8
...
complex carbon sources (Burke \emph{et al.}, 2011b; McIlroy and Nielsen,
2014; Crump \emph{et al.}, 2018). On the other hand, families
...
less pronounced taxa showed seasonal and host-specific patterns. For
...
whose cultured members are known polysaccharide degraders (Jørgensen and
...
this phylum showed seasonal patterns. The presence of this phylum only
on \emph{C. cylindracea} is to be expected as part of the epiphytic
community is directly in contact with the sediment. The
...
taxonomic groups (Burke \emph{et al.}, 2011a; Roth-Schulze \emph{et
al.}, 2016). It is possible that functional redundancy is a
characteristic of high abundance taxa detected to be present throughout
the year, while seasonal and/or host-specific functions are an attribute
of taxa displaying successional patterns. Further studies connecting
taxonomy with functional properties will be required to elucidate the
degree of functional redundancy or specificity in epiphytic microbial
communities.
...
\textless{}i\textgreater{}Hyphomonadaceae\textless{}i/\textgreater{}.
In, \emph{The prokaryotes:
\textless{}i\textgreater{}Alphaproteobacteria\textless{}i/\textgreater{}
and
\textless{}i\textgreater{}Betaproteobacteria\textless{}i/\textgreater{}}.
...
bacterial biofilms on the kelp \textless{}i\textgreater{}Laminaria
hyperborea\textless{}i/\textgreater{}. \emph{Aquatic Microbial Ecology}
\textbf{60}: 71--83.
...
\textless{}i\textgreater{}Posidonia oceanica\textless{}i/\textgreater{}.
\emph{Aquatic Botany} \textbf{125}: 72--79.
...
bacterial community of the green alga \textless{}i\textgreater{}Ulva
australis\textless{}i/\textgreater{}. \emph{The ISME Journal}
\textbf{5}: 590--600.
...
Seagrass Microbiomes. \emph{Frontiers in Microbiology} \textbf{9}: 388.
...
genome sequence of \textless{}i\textgreater{}Desulfatitalea
tepidiphila\textless{}/i\textgreater{} S28bF\(^{T}\). \emph{Genome
Announcements} \textbf{3}: e01326--15.
...
Jørgensen, B.B. and Gallardo, V.A. (1999)
\textless{}i\textgreater{}Thioploca\textless{}/i\textgreater{} spp.:
filamentous sulfur bacteria with nitrate vacuoles. \emph{FEMS
Microbiology Ecology} \textbf{28}: 301--313.
...
prokaryotes:
\textless{}i\textgreater{}Deltaproteobacteria\textless{}/i\textgreater{}
and
\textless{}i\textgreater{}Epsilonproteobacteria\textless{}/i\textgreater{}}.
...
Planktonic \textless{}i\textgreater{}Archaea\textless{}/i\textgreater{}
in the Santa Barbara Channel. \emph{Applied and environmental
microbiology} \textbf{63}: 50--56.

\leavevmode\hypertarget{ref-McIlroy2014}{}%
McIlroy, S.J. and Nielsen, P.H. (2014) The Family
\textless{}i\textgreater{}Saprospiraceae\textless{}/i\textgreater{}. In,
\emph{The prokaryotes: Other major lineages of
\textless{}i\textgreater{}Bacteria\textless{}/i\textgreater{} and the
\textless{}i\textgreater{}Archaea\textless{}/i\textgreater{}}.
Springer-Verlag Berlin Heidelberg, pp. 863--889.
...
\emph{Frontiers in Microbiology} \textbf{10}: 717.
...
and
\textless{}i\textgreater{}Betaproteobacteria\textless{}/i\textgreater{}}.
Springer-Verlag Berlin Heidelberg, pp. 439--512.
...
on the Leaves of \textless{}i\textgreater{}Cymodocea
nodosa\textless{}/i\textgreater{} in the Canary Islands. \emph{Botanica
...
\emph{FEMS Microbiology Letters} \textbf{366}: fnz057.
...
bacterial community associated with a green marine
\textless{}i\textgreater{}Ulvacean\textless{}/i\textgreater{} alga.
...
of Leaves and Roots Associated with Turtle Grass
(\textless{}i\textgreater{}Thalassia
testudinum\textless{}/i\textgreater{}) and Manatee Grass
(\textless{}i\textgreater{}Syringodium
filliforme\textless{}/i\textgreater{}) are Distinct from Seawater and
Sediment Communities, but Are Similar between Species and Sampling Si.
\emph{Microorganisms} \textbf{7}: 4.
...
\textless{}i\textgreater{}Halophila
stipulacea\textless{}/i\textgreater{} by a Culture-Independent
Small-Subunit rRNA Gene Approach. \emph{Microbial Ecology} \textbf{39}:
22--31.
...
R. In, Stodden,V., Leisch,F., and Peng,R.D. (eds), \emph{Implementing
...
Analysis of
\textless{}i\textgreater{}Cellvibrio\textless{}/i\textgreater{} sp. PR1,
a Xylanolytic and Agarolytic Bacterium from the Pearl River.
\emph{BioMed Research International} \textbf{2017}: 6304248.
...
seagrass \textless{}i\textgreater{}Cymodocea
nodosa\textless{}/i\textgreater{} (Ucr.) Asch. \emph{Scientia Marina}
\textbf{62}: 301--309.
