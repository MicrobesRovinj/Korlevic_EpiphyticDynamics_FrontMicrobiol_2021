...
(\autoref{supp-nseq_notus}), through rarefaction resulting in 17,180
different OTUs that ranged from 381 to 1,997 OTUs per sample
...
134.8 OTUs{]} and monospecific {[}Number of OTUs, 1,726.2 ± 156.0
OTUs{]}), middle values for \emph{C. nodosa} (Number of OTUs, 1,053.4 ±
210.7 OTUs) and lower values for picoplankton communities in the ambient
seawater (Number of OTUs, 535.7 ± 137.8 OTUs)
...
These OTUs also made a high proportion of total sequences (40.5 -- 51.3
...
supported (ANOSIM, R = 0.29, \emph{p} \textless{} 0.05)
(\autoref{pcoa}).
