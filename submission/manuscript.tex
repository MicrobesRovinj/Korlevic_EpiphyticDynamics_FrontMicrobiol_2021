...
\autoref{supp-nseq_notus}) through rarefaction resulting in 17,157
different OTUs with 371 to 2,071 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,685 ± 127.6
OTUs{]} and monospecific {[}Number of OTUs, 1,735.2 ± 166.6 OTUs{]})
than for \emph{C. nodosa} (Number of OTUs, 1,055.2 ± 212.0 OTUs) and
lowest values were obtained for the microbial community of the ambient
seawater (Number of OTUs, 533.4 ± 142.1 OTUs)
...
proportion of total sequences (40.7 -- 51.7 \si{\percent}). To further
...
accounting for a high proportion of sequences (\(\leq\) 51.7
