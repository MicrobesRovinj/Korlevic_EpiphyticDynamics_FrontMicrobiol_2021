...
\autoref{supp-nseq_notus}) through rarefaction resulting in 17,048
different OTUs with 374 to 2,035 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,684.7 ±
130.7 OTUs{]} and monospecific {[}Number of OTUs, 1,733.4 ± 152.0
OTUs{]}) than for \emph{C. nodosa} (Number of OTUs, 1,050 ± 210.1 OTUs)
and lowest values were obtained for the microbial community of the
ambient seawater (Number of OTUs, 528.4 ± 133.2 OTUs)
...
associated communities (\autoref{shared}). In addition, only 0.5 -- 1.0
...
proportion of total sequences (42.4 -- 50.7 \si{\percent}). To further
...
accounting for a high proportion of sequences (\(\leq\) 50.7
