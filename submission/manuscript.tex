...
different OTUs with 382 to 2,031 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,686.1 ±
142.8 OTUs{]} and monospecific {[}Number of OTUs, 1,729.5 ± 159.6
OTUs{]}) than for \emph{C. nodosa} (Number of OTUs, 1,064.1 ± 210.0
OTUs) and lowest values were obtained for the microbial community of the
ambient seawater (Number of OTUs, 525.4 ± 145.1 OTUs)
...
proportion of total sequences (41.4 -- 52.4 \si{\percent}). To further
