...
(\autoref{supp-nseq_notus}), through rarefaction resulting in 17,017
different OTUs that ranged from 360 to 2,108 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,675.9 ±
144.0 OTUs{]} and monospecific {[}Number of OTUs, 1,735.6 ± 175.0
OTUs{]}), middle values for \emph{C. nodosa} (Number of OTUs, 1,052.6 ±
204.9 OTUs) and lower values for picoplankton communities in the ambient
seawater (Number of OTUs, 525.3 ± 146.6 OTUs)
...
(Jaccard, 0.36; Bray-Curtis, 0.78), while lower shared values were
...
These OTUs also made a high proportion of total sequences (40.6 -- 52.6
...
supported (ANOSIM, R = 0.31, \emph{p} \textless{} 0.05)
(\autoref{pcoa}).
...
were accounting for a high proportion of sequences (\(\leq\) 52.6
