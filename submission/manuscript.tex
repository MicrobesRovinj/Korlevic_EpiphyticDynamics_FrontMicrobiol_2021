...
\autoref{supp-nseq_notus}) through rarefaction resulting in 16,986
different OTUs with 361 to 2,026 OTUs per sample
...
found for \emph{C. cylindracea} (mixed {[}Number of OTUs, 1,678.1 ±
143.6 OTUs{]} and monospecific {[}Number of OTUs, 1,734.2 ± 150.9
OTUs{]}) than for \emph{C. nodosa} (Number of OTUs, 1,054.2 ± 213.0
OTUs) and lowest values were obtained for the microbial community of the
ambient seawater (Number of OTUs, 529.1 ± 136.4 OTUs)
...
proportion of total sequences (36.9 -- 53.0 \si{\percent}). To further
...
accounting for a high proportion of sequences (\(\leq\) 53.0
