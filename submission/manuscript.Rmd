...
## Figures
\newpage
```{r out.width="80%", fig.align="center", fig.cap="Taxonomic classification and relative contribution of the most abundant bacterial sequences.\\label{community}", fig.pos="ht"}
