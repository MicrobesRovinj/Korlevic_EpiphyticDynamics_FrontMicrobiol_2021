...
## Figures
\newpage
```{r out.width="100%", fig.align="center", fig.cap="Taxonomic classification and relative contribution of the most abundant bacterial sequences.\\label{community}", fig.pos="ht"}
include_graphics("../results/figures/community_barplot_phylum.jpg")
```
